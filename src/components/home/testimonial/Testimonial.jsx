...
import Banner from "../../../assets/testimonial/testimonial-1.png";
import brush from "../../../assets/testimonial/testimonial-shape-1.png";
import swiperImage from "../../../assets/testimonial/team-1-2.jpg";
  ...
  return (
    <div className="testimonial-card">
      ...
      <p>
        ...
        through the use of digital technologies and the internet. Flexible
        Classes refers to the process flexible Classes refers to the process
      </p>
      ...
      <div className="card-banner">
        <div className="">
          <Swiper
            ...
            className="mySwiper testimonial-container"
          >
